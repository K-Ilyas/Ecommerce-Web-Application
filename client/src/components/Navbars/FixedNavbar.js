...
class FixedNavbar extends Component {
    ...
    updateNavbarColor = () => {
        if (document.documentElement.scrollTop > 140 || document.body.scrollTop > 140) {
            this.setState({ navbarColor: "fixed-top" });
        } else if (document.documentElement.scrollTop < 141 || document.body.scrollTop < 141) {
...
export default withRouter(connect(mapStateToProps, { signout })(FixedNavbar));
